...
- item Synchronized TDR dataset of 30 samples
- item Entire TDR dataset of 75 samples

The purpose of using these two datasets is to evaluate the model's performance and based on this analysis, determine the strategy for the Multi-modal transformer. The dataset is split into three groups for training and testing, as shown in Table \ref{Table:5.1}. 
...
\begin{figure}[!htb]
    \centering
    \input\includegraphics[width=0.95\textwidth]{student/figures/multimodal.png}
    \caption{Test accuracy results for Multi-modal transformer}
    \label{Fig: 5.3}
\end{figure}
